...
RSpec.feature 'Show advanced search' do
  ...
  describe 'Search by ethnicity' do
    it 'Works!' do
      ...
      click_on('Search')
      expect(page).to have_current_path("/shows?q%5Bname_cont%5D=&q%5Bcredits_author_ethnicity_contains%5D=asian_american&q%5Bcredits_author_gender_identity_eq%5D=&q%5Bcredits_author_lgbt_eq%5D=&q%5Bshow_type_eq%5D=&q%5Bgenre_eq%5D=&q%5Bpublic_domain_eq%5D=&commit=Search")
